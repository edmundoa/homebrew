...
class Wireshark < Formula
  ...
  url 'http://wiresharkdownloads.riverbed.com/wireshark/src/all-versions/wireshark-1.10.0.tar.bz2'
  mirror 'http://www.wireshark.org/download/src/all-versions/wireshark-1.10.0.tar.bz2'
